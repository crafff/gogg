...
export type TftLineupsQuery = { tftLineups: { platform: string, patch: string, setNumber: number, queueId: number, cohort: TftCohort, window: TftWindow, locale: string, algorithmVersion: string, publishedAt: string, sourceMatches: number, sourceParticipants: number, coverage: { windowStart: string, windowEnd: string, exactLineups: number, familyThreshold: number }, items: Array<{ id: string, starCompositionKnownSamples: number, starCompositionUnknownSamples: number, starCompositionCoverage: number, coreUnits: Array<{ id: string, name: string | null, iconUrl: string | null }>, commonItems: Array<{ count: number, rate: number, entity: { id: string, name: string | null, iconUrl: string | null } }>, commonAugments: Array<{ count: number, rate: number, entity: { id: string, name: string | null, iconUrl: string | null } }>, commonTraits: Array<{ count: number, rate: number, entity: { id: string, name: string | null, iconUrl: string | null } }>, unitItems: Array<{ isCore: boolean, coreRank: number | null, averageItems: number, itemInvestmentRate: number, equippedRate: number, threeItemRate: number, knownStarSamples: number, unknownStarSamples: number, starCoverage: number, unit: { id: string, name: string | null, iconUrl: string | null }, commonItems: Array<{ count: number, rate: number, entity: { id: string, name: string | null, iconUrl: string | null } }>, starDistribution: Array<{ stars: number, sampleSize: number, rate: number, knownRate: number, avgPlacement: number | null, firstRate: number | null, top4Rate: number | null }> }>, starLevels: Array<{ totalStars: number, sampleSize: number, lobbyCount: number, rate: number, avgPlacement: number, firstRate: number, top4Rate: number }>, starCompositions: Array<{ totalStars: number, sampleSize: number, rate: number, avgPlacement: number | null, firstRate: number | null, top4Rate: number | null, levels: Array<{ stars: number, unitCount: number }> }>, metrics: { sampleSize: number, lobbyCount: number, pickRate: number, avgPlacement: number, firstRate: number, top4Rate: number, contestedRate: number } }> } };
