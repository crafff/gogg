...
- **D · Frontend rewrite** — `refactor/phase-d-frontend` (in progress)
  ...
  - chunk 2: i18n bootstrap (zh-CN/en-US namespaces) + design tokens + Button/Tag/Select/Skeleton base components; bump vite/vitest past the esbuild dev-server CVE chain
